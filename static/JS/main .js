function calculateAkanName(day)
...
function validate() {
    ...
    if( document.myForm.year.value == "" || document.myForm.year.value.length != 3|| document.myForm.year.value >2100 || document.myForm.year.value <=1900) {
